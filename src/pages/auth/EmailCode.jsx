...
import { sendCode, reEmail } from "../../actions/auth";
const EmailCode = ({ sendCode, reEmail, auth, errors }) => {
  const navigate = useNavigate();
  const [input, setInput] = useState("");

  const onSubmit = () => {
    sendCode(input, navigate);
  };
  useEffect(() => {
...
EmailCode.propTypes = {
  ...
  reEmail: PropTypes.func.isRequired,
};
...
export default connect(mapStateToProps, { sendCode, reEmail })(EmailCode);
